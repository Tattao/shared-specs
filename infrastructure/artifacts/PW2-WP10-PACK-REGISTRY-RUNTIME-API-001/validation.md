...
```text
cd /Users/shitao/Projects/Codex/osmx && git diff --check -- osmx-go/internal/aof/pack/runtime_registry.go osmx-go/internal/aof/pack/runtime_registry_test.go osmx-go/internal/api/v1/aof_handler.go osmx-go/internal/api/v1/aof_handler_test.go osmx-go/internal/router/router.go docs/reports/aof-product-wave2-pack-registry-runtime-api-20260430.md
cd /Users/shitao/Projects/Codex/shared-specs && git diff --check -- infrastructure/artifacts/PW2-WP10-PACK-REGISTRY-RUNTIME-API-001
