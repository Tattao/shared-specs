...
```text
cd /Users/shitao/Projects/Codex/osmx && git diff --check -- osmx-go/internal/aof/twin/runtime_sample.go osmx-go/internal/aof/twin/runtime_sample_test.go osmx-go/internal/api/v1/aof_handler.go osmx-go/internal/api/v1/aof_handler_test.go osmx-go/internal/router/router.go docs/reports/aof-product-wave2-twin-runtime-api-20260430.md
cd /Users/shitao/Projects/Codex/shared-specs && git diff --check -- infrastructure/artifacts/PW2-WP2-TWIN-RUNTIME-API-001
